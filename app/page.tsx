...
import {
  ...
  PlatformHeroStatusBadge,
  PlatformStatusMessage,
  PlatformStatusProvider,
  PlatformSystemValue,
} from "@/components/landing/platform-status";
...
const benefits = [
  ...
  {
    description:
      "A calm, modern experience built to keep focus on the bankroll journey rather than noise.",
    icon: "pulse",
  ...
  {
    description:
      "A safer onboarding path with verification, protected profile steps, and clear account rules.",
    icon: "lock",
...
const transparencyCards = [
  ...
  },
  {
    cta: "Read Rules",
    description:
      "Simple policies, clear responsibilities, and fewer hidden assumptions across the platform.",
    icon: "gavel",
    title: "Clear Rules",
  },
] as const;
...
const faqs = [
  {
    answer:
      "The admin team curates the operational side, while your dashboard is focused on visibility, clarity, and access to the right pool information.",
    question: "How are the tickets selected?",
  },
  {
    answer:
      "The product still carries financial risk, but the experience is designed to reduce ambiguity with stronger transparency, verified flows, and traceable actions.",
    question: "Is my money safe?",
  },
  {
    answer:
      "Slot pricing is set by the monthly offer for that period, and your dashboard will always reflect the offer you are eligible to buy.",
    question: "What determines the entry amount?",
  },
  {
    answer:
      "Winnings are distributed after settlement according to the active rules, and your dashboard shows the inputs, status, and history clearly.",
    ...
    <PlatformStatusProvider>
      ...
      <section className="content-auto bg-white py-24" id="faq">
        <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
          <SectionHeading
            description="A few clear answers to set expectations as the Stakeloop experience continues to grow."
      ...
      >
        ...
        <div className="relative mx-auto max-w-4xl px-4 text-center sm:px-6 lg:px-8">
          ...
          <p className="mx-auto mt-5 max-w-2xl text-lg leading-8 text-slate-300">
            Join the early-access waitlist while we keep shaping the
            Stakeloop experience.
          </p>
          ...
          >
            ...
            <p className="text-sm leading-7 text-slate-300">
              This page is already connected to live platform status and
              the pilot waitlist.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-10 border-t border-border/80 pt-8 text-xs leading-7 text-muted">
            <p>
              ...
              involves financial risk, and the platform is designed to
              surface clearer information, not remove that risk entirely.
            </p>
